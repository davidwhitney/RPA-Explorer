...
public sealed class TempWorkspace : IDisposable
{
    ...
    {
        RpaParser parser = new RpaParser { ArchiveVersion = version, Padding = padding };
        ...
        foreach (KeyValuePair<string, byte[]> entry in entries)
        {
            ...
            parser.Index.Add(entry.Key, new RpaParser.ArchiveIndex
            {
                InArchive = false,
    ...
    public RpaParser LoadArchive(double version, IDictionary<string, byte[]> entries, string archiveName = "test.rpa")
    {
